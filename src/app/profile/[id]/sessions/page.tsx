                    ...
                    <tbody className="text-gray-600 divide-y">
                        {
                            sessionItems.map((item, idx) => (
                                <tr key={idx} className="odd:bg-gray-50 even:bg-white">
                                    ...
                                    <td className="px-6 py-4 whitespace-nowrap">{item.giversemail}</td>
                                    <td className="px-6 py-4 whitespace-nowrap">{item.receiversemail}</td>
                                    ...
                                    <td className="text-right px-6 whitespace-nowrap">
                                        <Link href={`/session/${2}/${'giver'}`} className="py-2 px-3 font-medium text-indigo-600 hover:text-indigo-500 duration-150 hover:bg-gray-50 rounded-lg">
                                            Open
                                        </Link>
                                    </td>
                                </tr>
