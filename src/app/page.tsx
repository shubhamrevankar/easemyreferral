        ...
        <div className="flex items-center justify-center w-full h-full bg-gray-900/40">
          <div className="text-center px-10">
            <h1 className="text-5xl text-white lg:text-8xl font-bold">
              We <span className="italic bg-gradient-to-r from-cyan-400  via-green-300 to-cyan-300 inline-block text-transparent bg-clip-text">ease</span> your <br/> <span className="inline-block sm:pt-8">Referral Process</span>
            </h1>
            {/* <button className="w-full px-5 py-2 mt-4 text-sm font-medium text-white capitalize transition-colors duration-300 transform bg-blue-600 rounded-md lg:w-auto hover:bg-blue-500 focus:outline-none focus:bg-blue-500">
              Start project
            </button> */}
            <Link href={"/createsession"} className="inline-block">
              <Button className="w-full px-2 py-3 md:px-5 md:py-8 mt-10 text-2xl md:text-3xl font-medium text-white capitalize transition-colors duration-300 transform bg-blue-600 rounded-md lg:w-auto hover:bg-blue-500 focus:outline-none focus:bg-blue-500">
                Create Session
              </Button>
            </Link>
          </div>
